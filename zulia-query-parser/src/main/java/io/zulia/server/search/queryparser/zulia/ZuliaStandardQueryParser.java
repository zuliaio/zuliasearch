 ...
 */
package io.zulia.server.search.queryparser.zulia;

import io.zulia.server.search.queryparser.zulia.builders.ZuliaStandardQueryTreeBuilder;
import io.zulia.server.search.queryparser.zulia.parser.ZuliaSyntaxParser;
import io.zulia.server.search.queryparser.zulia.processors.ZuliaQueryNodeProcessorPipeline;
 ...
 *
 * <pre class="prettyprint">
 * // the query config handler returned by {@link ZuliaStandardQueryParser} is a {@link StandardQueryConfigHandler}
...
public class ZuliaStandardQueryParser extends QueryParserHelper implements CommonQueryParserConfiguration {
	...
	public ZuliaStandardQueryParser() {
		super(new StandardQueryConfigHandler(),
				...
				new ZuliaSyntaxParser(), new ZuliaQueryNodeProcessorPipeline(null), new ZuliaStandardQueryTreeBuilder());
		setEnablePositionIncrements(true);
	}

	/**
	 * Constructs a {@link ZuliaStandardQueryParser} object and sets an {@link Analyzer} to it. The
	 * same as:
	 *
	 * <pre class="prettyprint">
