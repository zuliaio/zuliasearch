...
import org.apache.lucene.queryparser.flexible.standard.nodes.intervalfn.*;
...
public class ZuliaSyntaxParser implements SyntaxParser, ZuliaSyntaxParserConstants {
    ...
    final private QueryNode Query(CharSequence field) throws ParseException {
        ...
        if (clauses.size() == 1) {
            ...
            if (first instanceof ModifierQueryNode && ((ModifierQueryNode) first).getModifier() == ModifierQueryNode.Modifier.MOD_NOT) {
    ...
    final private QueryNode GroupingExpr(CharSequence field) throws ParseException {
        QueryNode q;
    ...
    final private IntervalFunction IntervalAtLeast() throws ParseException {
        IntervalFunction source;
    ...
    final private IntervalFunction IntervalMaxWidth() throws ParseException {
        IntervalFunction source;
        Token maxWidth;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalMaxGaps() throws ParseException {
        IntervalFunction source;
        Token maxGaps;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalUnordered() throws ParseException {
        IntervalFunction source;
        ArrayList<IntervalFunction> sources = new ArrayList<IntervalFunction>();
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalUnorderedNoOverlaps() throws ParseException {
    ...
    final private IntervalFunction IntervalOrdered() throws ParseException {
        IntervalFunction source;
        ArrayList<IntervalFunction> sources = new ArrayList<IntervalFunction>();
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalOr() throws ParseException {
        IntervalFunction source;
        ArrayList<IntervalFunction> sources = new ArrayList<IntervalFunction>();
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalPhrase() throws ParseException {
        IntervalFunction source;
        ArrayList<IntervalFunction> sources = new ArrayList<IntervalFunction>();
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalBefore() throws ParseException {
        IntervalFunction source;
    ...
    final private IntervalFunction IntervalAfter() throws ParseException {
        IntervalFunction source;
        IntervalFunction reference;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalContaining() throws ParseException {
    ...
    final private IntervalFunction IntervalNotContaining() throws ParseException {
    ...
    final private IntervalFunction IntervalContainedBy() throws ParseException {
        IntervalFunction big;
        IntervalFunction small;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalNotContainedBy() throws ParseException {
        IntervalFunction big;
        IntervalFunction small;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalWithin() throws ParseException {
    ...
    final private IntervalFunction IntervalExtend() throws ParseException {
        IntervalFunction source;
        Token before, after;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalNotWithin() throws ParseException {
    ...
    final private IntervalFunction IntervalOverlapping() throws ParseException {
        IntervalFunction source, reference;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalNonOverlapping() throws ParseException {
        IntervalFunction minuend, subtrahend;
        jj_consume_token(FN_PREFIX);
    ...
    final private IntervalFunction IntervalWildcard() throws ParseException {
        String wildcard;
    ...
    final private IntervalFunction IntervalFuzzyTerm() throws ParseException {
        String term;
        Token maxEdits = null;
        Token maxExpansions = null;
        jj_consume_token(FN_PREFIX);
        ...
        {
            if ("" != null)
                return new FuzzyTerm(term, maxEdits == null ? null : parseInt(maxEdits), maxExpansions == null ? null : parseInt(maxExpansions));
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final private IntervalFunction IntervalText() throws ParseException {
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            ...
            case TERM: {
                ...
                {
                    if ("" != null)
                        return new AnalyzedText(token.image);
                }
                break;
            }
            default:
    ...
    final private TermRangeQueryNode TermRangeExpr(CharSequence field) throws ParseException {
        ...
        FieldQueryNode qLower = new FieldQueryNode(field, discardEscapeChar(left.image), left.beginColumn, left.endColumn);
        FieldQueryNode qUpper = new FieldQueryNode(field, discardEscapeChar(right.image), right.beginColumn, right.endColumn);
