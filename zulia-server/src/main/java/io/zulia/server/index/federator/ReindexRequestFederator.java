...
public class ReindexRequestFederator extends PrimaryReplicaNodeRequestFederator<ReindexRequest, ReindexResponse> {
	private final InternalClient internalClient;
	private final ZuliaIndex index;

	public ReindexRequestFederator(Node thisNode, Collection<Node> otherNodesActive, ZuliaBase.PrimaryReplicaSettings primaryReplicaSettings, ZuliaIndex index,
