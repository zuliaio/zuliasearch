...
public class ClearRequestNodeFederator extends RequestNodeFederator<ClearRequest, ClearResponse> {
	private final InternalClient internalClient;
	private final ZuliaIndex index;

	public ClearRequestNodeFederator(Node thisNode, Collection<Node> otherNodesActive, ZuliaBase.MasterSlaveSettings masterSlaveSettings, ZuliaIndex index,
