...
@CommandLine.Command(name = "zuliaadmin", subcommands = { DisplayNodesCmd.class, DisplayIndexesCmd.class, DocCountCmd.class, ClearIndexCmd.class,
		...
		StatsCmd.class, FetchDocumentCmd.class, StoreDocumentCmd.class, DeleteDocumentCmd.class, GetFieldsCmd.class }, mixinStandardHelpOptions = true, versionProvider = ZuliaVersionProvider.class, scope = CommandLine.ScopeType.INHERIT)
